...
this.close.css({"background-color":this.mainColor});this.initColorCss()},initColorCss:function(){this.stage.css({color:this.fontColor})},initDefaultDom:function(){var a=this;this.close=$('\n\t\t\t<button class="close aria-label-button" aria-label="Close '+FormInfo.getFormTitle(this.formType)+'">\n\t\t\t\t<img src="'+this.closeUrl+'" alt="" aria-hidden="true">\n\t\t\t</button>\n\t\t');this.close.on(_event._click,function(){return a.hide()});this.leftBtn=$('\n\t\t\t<button class="leftBtn btn aria-label-button" aria-label="Previous Page">\n\t\t\t\t<img src="'+
this.leftButtonUrl+'" alt="" aria-hidden="true">\n\t\t\t</button>\n\t\t');this.rightBtn=$('\n\t\t\t<button class="rightBtn btn aria-label-button" aria-label="Next Page">\n\t\t\t\t<img src="'+this.rightButtonUrl+'" alt="" aria-hidden="true">\n\t\t\t</button>\n\t\t');this.pageCaption=$("<span class='pageCaption'></span>");this.initSwiper()},initSwiper:function(){this.thumbnailSwiper=$("<div class='thumbnailSwiper stage'></div>");this.thumbnailSwiperList=$("<div class='swiper'></div>");this.progress=
...
this.isRestrict(a)?this.itemArray[a].restrict||(this.itemArray[a].fillContent(),this.itemArray[a].restrict=!0):this.itemArray[a].fill||(this.LoadCount++,this.itemArray[a].loading(),this.itemArray[a].fillContent(),this.itemArray[a].fill=!0))},fillContent:function(){verifyPassward()&&(this.interval&&!this.interval.isRunning()?this.interval.start():this.interval=function(){this.performTask()}.interval(this,60))},performTask:function(){var a=this.getShownItems(),b=a[1];for(a=a[0];a<=b;a++){var c=function(){thumbnail.fillImage(this.index)}.bind({index:a});
...
e.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.DEFAULT),"TelephoneNumberButton"==e.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.LEFT),e.addTo(this.extended),e.hint=!1)}b<this.buttonCount&&(this.btnMore.addTo(this.container.body),this.btnMore.setPosition(a,this.buttonTop))},addPageButtons:function(a){function b(m){m.addTo(e);m.setPosition(f,h);f+=g}function c(){f+=k;0<d?(l.css({left:f+"px",top:n+"px",display:"block"}),f+=d):l.css({display:"none"});f+=k}var d=
this.edtNumber.width,e=this.container.body,f=a,g=this.buttonWidth,h=this.buttonTop,l=this.edtNumber.body,n=this.edtNumber.top,k=this.edtNumber.space;rightToLeft?(bookConfig.enablePageBack&&b(this.btnForward),b(this.btnLast),b(this.btnNext),c(),b(this.btnPrevious),b(this.btnFirst),bookConfig.enablePageBack&&b(this.btnBackward)):(bookConfig.enablePageBack&&b(this.btnBackward),b(this.btnFirst),b(this.btnPrevious),c(),b(this.btnNext),b(this.btnLast),bookConfig.enablePageBack&&b(this.btnForward));return f}}).extend("ButtonQueue");
Class("MobileButtonQueue",{sort:function(a,b){a=this.edtNumber.width+2*this.edtNumber.space+4*this.buttonWidth;this.addPageButtons(a,(this.container.width-a)/2);this.buttons.each(function(c){c.addTo(this.extended)}.bind(this))}}).extend("ButtonQueue");Class("PCToolbar",{initBar:function(){VolumeControlBar.config={color:this.color.toString(),iconColor:Color(bookConfig.iconColor).toString(),direction:VolumeControlBar.BOTTOM};this.topBar=$('<div class="fbTopBar" id = "fbTopBar"></div>');this.logoBar=$("<div id='logoBar' class='logoBar'></div>");this.pageBar=$("<div id='pageBar' class='pageBar'></div>");this.searchBar=$("<div class='searchBar'></div>");this.edtPageNumber=$("\n\t\t\t<div class='pageNumber' id='tfPageIndex'>\n\t\t\t\t<label for=\"currentPageIndexTextField\" class=\"sr-only\">\n\t\t\t\t\t\t\t"+
getLanguage("ariaPageNumber","page number")+"\n\t\t\t\t</label>\n\t\t\t\t<input \n\t\t\t\t\taria-label='"+getLanguage("ariaPageNumber","page number")+"' \n\t\t\t\t\ttype='text' \n\t\t\t\t\tid='currentPageIndexTextField' \n\t\t\t\t\tautocomplete='off' \n\t\t\t\t\tsize='13' \n\t\t\t\t\tvalue='' \n\t\t\t\t/>\n\t\t\t</div>\n\t\t");this.edtPageNumber.find("input").css({color:Color(bookConfig.pageNumColor).toString()});this.parent.append(this.topBar);this.topBar.append(this.pageBar);this.pageBar.append(this.edtPageNumber);
this.topBar.append(this.searchBar);this.initSearchBar();this.initPageNumber();this.topBar.append(this.logoBar);this.initStyle()},initStyle:function(){this.topBar.css("background-color",this.color.rgba(this.topBarAlpha));this.topBar.addBorderShadow(this.color.reduce(20),0,1);this.topBarAlpha&&!bookConfig.toobarClear||this.topBar.css({"background-color":"transparent","box-shadow":"none","-webkit-box-shadow":"none"});this.searchBackgroundColor=Color(this.color.add(160));this.searchFontColor=Color(this.searchBackgroundColor.add(32));
this.searchBar.css("background-color",this.searchBackgroundColor.toString());this.searchBar.find("input").css("background-color",this.searchBackgroundColor.toString())},resetToolbarColor:function(){this.color=Color(bookConfig.toolbarColor);this.topBarAlpha=Math.min(bookConfig.topToolBarAlpha,bookConfig.ToolBarAlpha);this.topBar.css({"background-color":this.color.rgba(this.topBarAlpha)});this.extendedBar&&this.extendedBar.$bar.css({"background-color":this.color.rgba(this.topBarAlpha)});this.topBarAlpha?
this.topBar.addBorderShadow(this.color.reduce(20),0,1):this.topBar.css({"box-shadow":"none","-webkit-box-shadow":"none"});this.resetButtonTitleColor();global.PcTelephoneNumberFrame&&global.PcTelephoneNumberFrame.setColor({color:bookConfig.toolbarColor,textColor:bookConfig.iconFontColor})},initSearchBar:function(){this.btnPreSearch=this.pickButton("search");this.btnPreSearch||(this.btnPreSearch=new SearchButton,this.setButtonTitle(this.btnPreSearch));this.btnPreSearch.onClick=this.onSearchButtonClick.bind(this);
this.edtPreSearch=$('\n      <div id=\'preSearchContent\'>\n        <label for="preSearchValue" class="sr-only">\n          '+FormInfo.getFormTitle("search")+"\n        </label>\n        <input \n          aria-label='"+FormInfo.getFormTitle("search")+"' \n          type='text' \n          id='preSearchValue' \n          placeholder='"+FormInfo.getFormTitle("search")+"' \n          class='preSearch' \n          size='16' \n        />\n      </div>\n\t\t");this.isRightToLeft()&&(this.edtPreSearch.find("input").attr("dir",
"rtl"),this.edtPreSearch.find("input").css({"margin-left":"0px","margin-right":"5px"}),this.btnPreSearch.$button.css({float:"left"}),this.edtPreSearch.css({float:"right"}));this.searchBar.append(this.edtPreSearch);this.btnPreSearch.addTo(this.searchBar);this.btnPreSearch.$button.asButton();this.btnPreSearch.$button.changeButtonColor(bookConfig.toolbarColor);bookConfig.SearchButtonVisible||this.searchBar.css("display","none")},initPageNumber:function(){var a=this.edtPageNumber.find("input");a.css({color:Color(bookConfig.pageNumColor).toString()});
...
new PcTelephoneNumberBubble({parent:this.parent,color:this.color,textColor:a.fontColor,margin:4,padding:15,arrowHeight:8,arrowWidth:8});else{var b=new TextBubble({parent:this.parent,text:a.caption,color:this.color,textColor:a.fontColor,margin:12});a.setTitle(b)}},initExtendedbar:function(){this.extendedBar=new PCExtendedBar(this.parent);global.moreBar=this.extendedBar},initEvents:function(){this._super();var a=this.edtPreSearch.find("input");this.edtPreSearch.bind("keydown",function(b){13==b.keyCode&&
this.btnPreSearch.click()}.bind(this));a.bind("focus",function(b){this.searchBar.css("background-color","white");this.edtPreSearch.css({"background-color":"white"});a.css({"background-color":"white",color:"black"})}.bind(this));a.bind("blur",function(b){this.searchBar.css("background-color",this.searchBackgroundColor.toString());this.edtPreSearch.css({"background-color":this.searchBackgroundColor.toString()});a.css("background-color",this.searchBackgroundColor.toString())}.bind(this));this.searchBar.bind("mouseenter",
function(){this.searchBar.css({"background-color":"white"});this.edtPreSearch.css({"background-color":"white"});a.css({"background-color":"white",color:"black"})}.bind(this));this.searchBar.bind("mouseleave",function(){this.focus||(this.searchBar.css({"background-color":this.searchBackgroundColor.toString()}),this.edtPreSearch.css({"background-color":this.searchBackgroundColor.toString()}),a.css({"background-color":this.searchBackgroundColor.toString(),color:this.searchFontColor.toString()}))}.bind(this))},
showOrHideSearchBar:function(){var a=this.parent.width();a-=2*Math.min(a/8,100);var b=this.getTopRightButtonWidth();b&&this.searchBar.css("right",b+25+"px");b=this.searchBar.width()+b;this.logoBar.width();a=(a-(this.edtPageWidth+8+180+20))/2;bookConfig.SearchButtonVisible?b>a?this.searchBar.css("display","none"):this.searchBar.css("display","block"):this.searchBar.css("display","none")},onSearchButtonClick:function(a){frmSearch.visible||frmSearch.show();a=this.edtPreSearch.find("input").val();frmSearch.search(a)},
addTopRightButton:function(){this.topRightButton||(this.topRightButton=$("<div class='topRightButton' id='createButton'></div>"),bookConfig.ToolBarVisible?this.topBar.append(this.topRightButton):this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),this.topRightButton=null)},getTopRightButtonWidth:function(){return this.topRightButton&&this.topRightButton.width()+15||0},onResize:function(a,b){if(bookConfig.ToolBarVisible){a=void 0==
a?this.parent.width():parseInt(a);void 0==b?this.parent.height():parseInt(b);b=Math.min(a/8,100);a-=2*b;this.topBar.css({width:a+"px",left:b+"px"});b=this.getTopRightButtonWidth();b=this.searchBar.width()+b+40;var c=this.logoBar.width()+20,d=(a-(this.edtPageWidth+8+180+20))/2;this.showOrHideSearchBar();c>d?(c=20,this.logoBar.css({display:"none"}),this.topRightButton&&this.topRightButton.css({display:"none"})):(this.logoBar.css({display:"block"}),this.topRightButton&&this.topRightButton.css({display:"flex"}));
b=Math.max(b,c);this.pagebarWidth=a-2*b;this.pageBar.css({width:this.pagebarWidth+"px",left:b+"px"});this.resetButtonPosition()}},resetButtonPosition:function(){(new PCButtonQueue({buttons:this.buttons,buttonWidth:36,buttonTop:9,container:{body:this.pageBar,width:this.pagebarWidth},extended:this.extendedBar.$bar,edtNumber:{body:this.edtPageNumber,width:this.edtPageWidth+8,top:11,space:5}})).sort();this.extendedBar.resize(this.buttonsInExtendedBar());this.extendedBar.hide();this.buttons.each(function(a){a.changeColor();
